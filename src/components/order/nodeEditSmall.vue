				...
				<div class="section section-warning">
					...
					<div class="warningBox">
						<ul>
							<li>
								预计需要占用合同周期
								<Input v-model="wDate" size="small"></Input>天
							</li>
							<li>
								或者，预计占用合同周期天数的
								<Input v-model="wDate" size="small"></Input>%
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="section section-warning">
					...
					<div class="warningBox">
						<ul>
							...
							<li>
								距计划完成日期剩余
								<Input v-model="wDate" size="small" style="width:50px;"></Input>
								天开始预警，期间发送
								<Select v-model="sendTimes" style="width:70px">
							...
							<li>
								<Checkbox v-model="single1">
									合同签订后
									<Input v-model="wDate1" size="small" style="width:50px;"></Input>天若未完成，则每天预警1次
								</Checkbox>
							</li>
							<li>
